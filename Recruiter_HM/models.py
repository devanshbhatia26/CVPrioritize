...
class JobPost(models.Model):
    ...
    qualification = models.CharField(max_length=2000,validators = [MinLengthValidator(2)])
    additional_qualification = models.CharField(max_length=2000,null=True,blank=True,validators = [MinLengthValidator(2)])
    overall_experience = models.CharField(max_length=6, choices=EXPERIENCE_CHOICES, default='0-2')
    primary_skills=models.CharField(max_length=30,validators=[MinLengthValidator(1)])
    secondary_skills=models.CharField(max_length=30,null=True,blank=True,validators=[MinLengthValidator(1)])
    tertiary_skills=models.CharField(max_length=30,null=True,blank=True,validators=[MinLengthValidator(1)])
