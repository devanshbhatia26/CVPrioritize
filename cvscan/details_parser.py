...
def fetch_skills(cleaned_resume):
  skils = [" c ", " c++ ", " java ", " data structures ", " datastructures ", " python ", " sql ", " rdbms ", " dbms ", " algorithms ", " advanced algorithms ", " ada ", " c# ", " dsa ", " daa ", " dotnet ", " .net ", " network programming ", " adobe photoshop ", " google analytics ", " network security ", " frontend ", "front end ", " back end", " backend ", " html ", " php ", " css ", " javascript ", " java script ", " nodejs ", " reactjs ", " angularjs ", " angular ", " analytics ", " android ", " android development ", " core java ", " advanced java ", " photoshop ", " analytics ", " spring ", " hibernate ", " daa ", " accounting ", " accounts ", " logical reasoning ", " it proficiency ", " msoffice ", " ms office ", " powerpoint ", " excelsheet ", " excel Sheet ", " finance ", " content writing ", " writing ability ", " audit ", " communication skills ", " communication ", " marketing ", " commercial awareness ", " data mining ", " statistical analysis ", " statistics ", " big data "," bigdata ", " cloud ", " matlab ", " image processing", " imageprocessing ", " cloud computing ", " machine learining ", " artificial intelligence ", " ai ", " data analytics ", " cyber security ", " cybersecurity ", " ccns ", " ccnp ", " ccna ", " operating systems ", " os ", " operating system ", " bpo ", " nursing ", " customer service ", " healthcare ", " management ", " biotechnology "]
  ...
  for skill in skill_sets:
    if (skill.lower() in skils) and (skill not in skill_set):
...
def fetch_qualifications(resume_text):
  ...
  for qualification in qualifications:
    ...
    regex_result = re.search(regular_expression, resume_text)
    while regex_result:
      if qualification not in degree:
